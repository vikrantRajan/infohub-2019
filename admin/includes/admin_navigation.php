<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li><a href="">Users Online: <?php echo Users::usersOnline(); ?></a></li>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="viewcontact.php"><i class="fa fa-fw fa-dashboard"></i> Contact</a>
            </li>
            ...
            <li>
                <a href="posts.php?source=add_post"><i class="fa fa-fw fa-file"></i> Add Post</a>
            </li>
            <?php
            }
            ?>
